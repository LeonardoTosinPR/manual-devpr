...
Existem várias formas de apoiar, e **nem todas envolvem dinheiro**.
...
- Coffee break para meetups
- Material de divulgação (adesivos, banners)
- Infraestrutura para conferências
...
- Indique o DevParaná para coordenadores de cursos de tecnologia da sua cidade
...
- Licenças de software para sorteios
- Brindes e materiais para eventos
- Acesso a plataformas de aprendizado
- Vagas para divulgação na comunidade

Entre em contato com a organização local para alinhar uma parceria.
