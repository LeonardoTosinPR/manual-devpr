...
O DevParaná Guarapuava é mantido por voluntários. Sempre há algo que pode ser melhorado, expandido ou simplesmente mantido funcionando. Se você quer contribuir mas não sabe por onde começar, aqui estão as necessidades atuais.
...
- Divulgar internamente nas empresas
- Levar a informação para universidades e escolas técnicas
- Criar conteúdo sobre os eventos (fotos, posts, vídeos)
...
- Ajudar na organização do espaço
- Cuidar da logística do coffee break
- Fotografar ou gravar
- Auxiliar palestrantes com projetor/áudio

---

## 🧭 Organizadores

Se você tem disponibilidade regular (~2h por semana) e quer fazer parte da organização do DevParaná Guarapuava, venha para as nossas reuniões mensais (veja abaixo) ou fale com a liderança local.
...
- Espaço para eventos
- Patrocínio de coffee break
- Brindes e licenças para sorteio
- Divulgação de vagas

Entre em contato com a organização local.
