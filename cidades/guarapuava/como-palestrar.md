...
3. Pronto! É só preparar e se divertir.

## O que posso apresentar?

Qualquer tema relacionado a tecnologia e desenvolvimento de software. Alguns exemplos:

- Uma linguagem ou framework que você gosta
- Um problema que resolveu no trabalho
- Boas práticas, arquitetura, testes
- Carreira, soft skills, experiências pessoais
- Ferramentas, produtividade, DevOps
- Algo que acabou de aprender e quer compartilhar
...
Manda no Slack do DevParaná ou fala com um dos organizadores locais. A gente ajuda a moldar a ideia e te dá suporte para transformar em uma talk.

> _"Incentivar que novas pessoas iniciem suas vidas como palestrantes cria um ciclo que retroalimenta a comunidade."_
